...
// Частицы-постфиксы, присоединяемые к глаголу через "-"
wordentry_set ГлагПостфиксДеф1 = {
частица:ка{}, // Пойдём-ка мы домой
частица:то{}, // Отчего умер-то?
частица:кось{}, // Глянь-кось, шуба ожила!
частица:таки{}, // Они добавили-таки ложку дегтя в бочку меда.
частица:с{} // Загадали желания – ждем-с!
}
