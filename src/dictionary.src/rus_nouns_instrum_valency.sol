...
automat sg
{
 ...
 тв( начертание ) // Начертание палочкой букв было достаточно простым.
 ...
 тв(завоевание) // Принял ислам после завоевания мусульманами Мекки.

 тв(гордость)
 тв(пополнение)  // Отсутствовало пополнение людьми.
 тв(больной) // Больные псевдотуберкулезом продолжают поступать в больницу
 тв(больная)
