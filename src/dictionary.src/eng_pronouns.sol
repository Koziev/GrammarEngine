...
//
// Content:
// Лексикон - определения форм местоимения I для английского раздела Словаря.
//
...
automat sg
{
 ...
 entry I : ENG_PRONOUN
 {
  ...
  NOUN_FORM:BASIC |{
                    // Субъектные формы - выступают в роли подлежащего.
                    CASE:NOMINATIVE |{
                    ...
                    // Объектные формы - прямое дополнение и именная часть предложной фразы
                    CASE:PREPOSITIVE |{
  ...
  // Атрибутивные формы - выступают в роли правого определения для существительного.
