...
AdvAdj(совершенно, равнодушный, 5) // Его поцелуи оставляли ее совершенно равнодушной.
AdvAdj(божественно, здоровый, 5) // Моя душа сразу заново рождается Божественно здоровой.
AdvAdj(искусственно, выращенный, 10) // Американским ученым удалось пересадить крысе искусственно выращенную почку.
AdvAdj(Беспрестанно, хлещущий, 10) // Беспрестанно хлещущий дождь отгонял сон.
AdvAdj(глубоко, символичный, 5) // Что кажется глубоко символичным.
AdvAdj(хорошо, оплачиваемый, 5) // Риск - дело хорошо оплачиваемое.
AdvAdj(жутко, крепкий, 5) // Но коктейль был жутко крепкий.
AdvAdj(мучительно, долгий, 5) // ночь была мучительно долгой
AdvAdj(почти,новый,5) // Почти новый, все работает.
...
AdvAdj(истинно, народный, 5) // Фрагментарная образованность позволяет Дэну Брауну быть истинно народным писателем
AdvAdj(постоянно, действующий, 5) // Звоните, есть постоянно действующие скидки
AdvAdj(практически, любой, 2) // Умеем работать практически любым инструментом.
AdvAdj(глубоко, верующий, 5) // Борис Пастернак был глубоко верующим человеком.
