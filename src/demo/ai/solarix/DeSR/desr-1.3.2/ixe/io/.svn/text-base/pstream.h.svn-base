/* $Id: pstream.h,v 1.3 2007-07-26 15:52:49 attardi Exp $
 ...
 *
 * Defines classes IXE::io::ipstream, IXE::io::opstream, IXE::io::pstream
 * and IXE::io::rpstream.
 *
 * Modified by Giuseppe Attardi for inclusion in IXE.
 */
...
namespace io
{
  /// Convert an ios::openmode to a string.
  std::string
  ...
  /**
   * @a mode is masked with @c (ios::in|ios::out)
...
namespace io
{
  ...
  struct pstreams
  {
    ...
    static const pmode pstdin  = std::ios::out; ///< Write to stdin
    static const pmode pstdout = std::ios::in;  ///< Read from stdout
    static const pmode pstderr = std::ios::app; ///< Read from stderr
