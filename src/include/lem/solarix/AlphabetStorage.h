 ...
 namespace Solarix
 {
  ...
  {
   protected:
    AlphabetStorage(void) {}

   public:
    virtual ~AlphabetStorage(void) {}
    ...
    virtual int CountAlphabets(void)=0;
    ...
    virtual int CountCoords(void)=0;
    ...
    virtual LS_ResultSet* ListClasses(void)=0;
    virtual int FindClass( const lem::UCString &name )=0;
    virtual int CountClasses(void)=0;
    ...
    virtual int CountEntries(void)=0;
    virtual int CountEntryForms(void)=0;
    ...
    virtual void DeleteSyllabRules(void)=0;
    ...
    virtual LS_ResultSet* ListSyllabRules(void)=0;
    virtual LS_ResultSet* ListSyllabConditionPoints(void)=0;
    virtual LS_ResultSet* ListSyllabResultPoints(void)=0;
