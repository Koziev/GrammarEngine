 ...
 namespace Solarix
 {
  ...
  class SyllabContextPoint
  {
   ...
   protected:
    SyllabContextPoint(void);

   public:
    SyllabContextPoint( const SyllabContextPoint &x );

    bool IsSyllab(void) const { return is_syllab; }
    bool IsLeftBoundary(void) const { return is_left_boundary; }
    bool IsRightBoundary(void) const { return is_right_boundary; }

    lem::UCString BuildSyllab( bool Normalized ) const;

    lem::uint32_t GetChar(void) const { return char_ucs4; }
    lem::uint32_t GetNormalizedChar(void) const { return normalized_char_ucs4; }

    int GetEntryID(void) const { return id_entry; }
    int GetClassID(void) const { return id_class; }
  ...
  {
   public:
    SyllabContextLeftBoundary(void) { is_left_boundary=true; }
  };

  class SyllabContextRightBoundary : public SyllabContextPoint
  {
   public:
    SyllabContextRightBoundary(void) { is_right_boundary=true; }
  };
  ...
  class SyllabRule : lem::NonCopyable
  {
   ...
   public:
    ...
    int GetSource(void) const { return id_src; }
    const lem::UCString& GetName(void) const { return name; }
    const SyllabCondition& GetCondition(void) const { return condition; }
          SyllabCondition& GetCondition(void) { return condition; }
    const SyllabResult& GetResult(void) const { return result; }
          SyllabResult& GetResult(void) { return result; }
  };
  ...
  class SyllabRulesForLanguage : lem::NonCopyable
  {
   ...
   public:
    ...
    int GetMinLen(void) const { return min_len; }
