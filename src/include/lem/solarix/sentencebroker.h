 ...
 namespace Solarix
 {
  ...
  class SentenceTokenizer : lem::NonCopyable
  {
   ...
   public:
    ...
    virtual ~SentenceTokenizer(void) {}
  ...
  class EuroSentenceTokenizer : public SentenceTokenizer
  {
   ...
   public:
    ...
    virtual bool IsTokenDelimiter( wchar_t c ) const;

    void InitSpecialCases(void);

    virtual bool IsUnbreakableFront( wchar_t c ) const
    { return unbreakable_front.empty() || unbreakable_front.find(c)!=unbreakable_front.end(); }

    virtual bool IsUnbreakableFront( const lem::UCString &s ) const;
    virtual bool IsMatched( const lem::UCString &s ) const;

    virtual int MatchLen( const lem::UFString & s, int i0 ) const;
  };
  ...
  class ExternalTokenizer : public SentenceTokenizer
  {
   protected:
    ...
    lem::UFString GetErrorText(void) const;
   ...
   public:
    ...
    virtual ~ExternalTokenizer(void);
