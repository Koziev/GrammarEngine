            ...
            )
        {
            ...
            if (ivar != UNKNOWN)
            {
                ...
                else
                {
                    ...
                    WrittenTextAnalysisSession current_analysis(sol_id, nullptr);
                    current_analysis.params.SetLanguageID(id_lang);
                    current_analysis.params.CompleteAnalysisOnly = true;
    ...
    if (tn_id == UNKNOWN && !cleanup)
    {
        ...
        if (segmentation)
        {
            ...
            if (is_language == id_lang)
            {
                ...
                else
                {
                    ...
                    Sentence toks;
                    toks.Parse(te_text, false, sol_id, id_lang, nullptr);
        ...
        else if (pivot)
        {
            if (is_language == id_lang)
            {
                ...
                Sentence sent;
                sent.Parse(te_text, false, sol_id, id_lang, nullptr);
