...
bool WordFormEnumerator_File2::Fetch(void)
{
 if( !finished )
  {
   if( icur_entry==-1 )
...
void WordFormEnumerator_File2::FetchEntry(void)
{
 if( !finished )
  {
...
int WordFormEnumerator_File2::GetEntryKey(void)
{
...
int WordFormEnumerator_File2::GetFormIndex(void)
{
 LEM_CHECKIT_Z(!finished);
...
float WordFormEnumerator_File2::GetValue(void)
{
 return 1.0F;
}

int WordFormEnumerator_File2::GetMatchedWordIndex(void)
{
 return 0;
}
