...
WordEntries_MySQL::~WordEntries_MySQL(void)
{
 cnx->Release();
 return;
}
...
int WordEntries_MySQL::GetMaxMultilexemLen_Impl(void)
{
...
WordEntryEnumerator* WordEntries_MySQL::ListEntries(void)
{
...
int WordEntries_MySQL::CountLexemes(void)
{
 MySQLCnx *c = cnx->GetDb();
 #if defined LEM_THREADS
 lem::Process::CritSecLocker guard(&c->cs);
...
LexemeEnumerator* WordEntries_MySQL::ListLexemes(void)
{
...
void WordEntries_MySQL::GetUEntries_Impl(void)
{
