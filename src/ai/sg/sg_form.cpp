...
//
// Content:
//  ласс SG_EntryForm. √рамматические формы описываютс€ как комбинации лексема+
// список_состо€ний_координат.  ласс SG_EntryForm хранит как текстовое
// представление словоформы статьи, так и вектор состо€ний. ѕарадигма слова -
...
/*******************************************************************
 ≈сли список измерений Dim содержит те же состо€ни€ координат, что
 и список словоформы, то возвращает true. ѕри этом пор€док координат
...
// ****************************************************************************
// — учетом весов координат, возвращаетс€ суммарный вес соответствующих пар
// ****************************************************************************
...
// *****************************************************************************
// ¬озвращает число координатных пар, совпадающих у списка формы и Dim.
// ≈сли у списков есть координаты с несовпадающими состо€ни€ми, то возвращаетс€
// 0.
// *****************************************************************************
...
/*
       if( pair.GetState()!=Pair.GetState() )
        // ѕервое же несовпадение портит весь результат...
        return 0;
       n++; 
*/
       // 15.01.2009 - из-за наличи€ "многоохватных" координат типа падежа дл€
       // глаголов или предлогов, будем искать именно совпадени€. Ќесовпадение еще
