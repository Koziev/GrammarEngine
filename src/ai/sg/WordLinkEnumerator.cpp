...
WordLinkEnumerator::~WordLinkEnumerator(void)
{
 lem_rub_off(rs);
 return;
}
...
bool WordLinkEnumerator::Fetch(void)
{
 if( rs==NULL )
  {
   if( ekey1==UNKNOWN )
...
int WordLinkEnumerator::GetLinkId(void)
{
 return rs->GetInt(0);
}

int WordLinkEnumerator::GetEntryKey1(void)
{
 if( ekey1==UNKNOWN )
...
int WordLinkEnumerator::GetEntryKey2(void)
{
 return rs->GetInt(ekey2_field);
}


int WordLinkEnumerator::GetLinkType(void)
{
...
int WordLinkEnumerator::GetTagsId(void)
{
...
SG_TagsList WordLinkEnumerator::GetTags(void)
{
 const int id_tags = rs->GetInt(tags_field);
