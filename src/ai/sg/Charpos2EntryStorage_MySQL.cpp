...
Charpos2EntryStorage_MySQL::~Charpos2EntryStorage_MySQL()
{
    cnx->Release();
    return;
}
...
Charpos2EntryEnumerator* Charpos2EntryStorage_MySQL::Enumerate()
{
...
void Charpos2EntryStorage_MySQL::BeginTx()
{
    cnx->BeginTx();
    return;
}

void Charpos2EntryStorage_MySQL::CommitTx()
{
    cnx->CommitTx();
    return;
}
