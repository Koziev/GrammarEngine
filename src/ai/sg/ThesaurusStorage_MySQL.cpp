...
void ThesaurusStorage_MySQL::Connect()
{
    return;
}


void ThesaurusStorage_MySQL::Disconnect()
{
    cnx->Release();
    return;
}
...
void ThesaurusStorage_MySQL::BeginTx()
{
    cnx->BeginTx();
    return;
}

void ThesaurusStorage_MySQL::CommitTx()
{
    cnx->CommitTx();
    return;
}

void ThesaurusStorage_MySQL::RollBackTx()
{
    cnx->RollbackTx();
    return;
}
...
TransactionGuard* ThesaurusStorage_MySQL::GetTxGuard()
{
...
LS_ResultSet* ThesaurusStorage_MySQL::List_TagSets()
{
...
LS_ResultSet* ThesaurusStorage_MySQL::ListTagDefs()
{
...
LS_ResultSet* ThesaurusStorage_MySQL::ListWordLinks()
{
            ...
            if (id_tag_set == -1)
            {
                ...
                if (rc == 0)
                {
                    ...
                    if (res != nullptr)
                    {
                        ...
                        lem::Ptr<LS_ResultSet_MySQL> rs = new LS_ResultSet_MySQL(c, res, nullptr);
                        while (rs->Fetch())
                        {
...
LS_ResultSet* ThesaurusStorage_MySQL::ListPhraseLinks()
{
...
void ThesaurusStorage_MySQL::CreateSchema()
{
}
