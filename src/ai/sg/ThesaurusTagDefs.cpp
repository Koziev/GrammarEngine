...
ThesaurusTagDefs::ThesaurusTagDefs(void):db(NULL)
{
}


ThesaurusTagDefs::~ThesaurusTagDefs(void)
{
}
...
ThesaurusTagDefsEnumerator* ThesaurusTagDefs::Enumerate(void)
{
...
const ThesaurusTag& ThesaurusTagDefs::operator[]( int id_tag )
{
 ...
 std::map<int,const ThesaurusTag*>::const_iterator it = id2tag.find(id_tag);
 if( it==id2tag.end() )
  {
