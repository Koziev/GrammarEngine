...
bool WordFormEnumerator_File3::Fetch(void)
{
 if( !finished )
  {
   if( icur_entry==-1 )
...
void WordFormEnumerator_File3::FetchEntry(void)
{
 if( !finished )
  {
...
int WordFormEnumerator_File3::GetEntryKey(void)
{
...
int WordFormEnumerator_File3::GetFormIndex(void)
{
 LEM_CHECKIT_Z(!finished);
...
float WordFormEnumerator_File3::GetValue(void)
{
 return 1.0F;
}

int WordFormEnumerator_File3::GetMatchedWordIndex(void)
{
